                ...
                char __user *buf, size_t len, loff_t *off)
{
        ...
        smp_call_function_single(2,interrupt_call,NULL,1);
	return 0;
}
/*
...
static int __init etx_driver_init(void)
{
        ...
        if((alloc_chrdev_region(&dev, 0, 1, "etx_Dev_tasd")) <0){
        ...
        if(IS_ERR(dev_class = class_create("etx_class_tasd"))){
            printk(KERN_INFO "Cannot create the struct class\n");
            goto r_class;
        }
 
        /*Creating device*/
        if(IS_ERR(device_create(dev_class,NULL,dev,NULL,"etx_device_tasd"))){
            printk(KERN_INFO "Cannot create the Device 1\n");
            goto r_device;
        }
 
        /*Creating a directory in /sys/kernel/ */
        kobj_ref = kobject_create_and_add("etx_sysfs_tasd",kernel_kobj);
        ...
        printk(KERN_INFO "Tasklet Dynamic Device Driver Insert...Done!!!\n");
        return 0;
...
static void __exit etx_driver_exit(void)
{
        ...
        cdev_del(&etx_cdev);
        unregister_chrdev_region(dev, 1);
        printk(KERN_INFO "Tasklet Dynamic Device Driver Remove...Done!!!\n");
}
