/* Implementation of Exporting Symbol Driver Code 2 */
...
extern int etx_count;       // variable to be accessed
void etx_shared_func(void); //Function declaration is by default extern
